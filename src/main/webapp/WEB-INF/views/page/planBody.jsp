						...
						<table>
							...
							<tr>
								...
								<td><textarea style="width: 500px" rows="10" cols="10"
										id="planBody" name="planBody">${classPlan.planBody }</textarea></td>
							</tr>
...
<!-- 						</div> -->
					...
					<div>
					<a class="btn btn-primary" href="planEdit?planNo=${classPlan.planNo}&classId=${classId}&id=${loginInfo.id }&userType=${ loginInfo.userType }"
						data-confirm-update> <i class="glyphicon glyphicon-update"></i>수정</a> 
					
					   <a class="btn btn-danger"  href="delete?planNo=${classPlan.planNo}&classId=${classId}&id=${loginInfo.id }&userType=${ loginInfo.userType }"
						data-confirm-delete  onclick="return confirm('삭제 하시겠습니까?')"> <i class="glyphicon glyphicon-remove"></i>삭제</a> 
						
						<a href="planBoard?classId=${classId}&id=${loginInfo.id}&userType=${loginInfo.userType}"
